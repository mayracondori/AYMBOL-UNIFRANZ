...
<html>
  ...
  <body class="text-blueGray-100 antialiased">
    ...
    <div id="root">
      ...
      >
        ...
        >
          ...
          >
            ...
            <h4> <?php $milogueo= session('Correo_inst');    
            ...
            >
              <li class="items-center">
                <a
                  href="http://localhost/aymbol/public/vendedor/registroauto"
              ...
              <li class="items-center">
                <a
                  href="http://localhost/aymbol/public/vendedor/registromoto"
                  class="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
                >
                  <i
                    class="fas fa-fingerprint text-blueGray-300 mr-2 text-sm"
              ...
              <li class="items-center">
                <a
                  href="http://localhost/aymbol/public/vendedor/listaautos"
                  class="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
                >
                  <i
                    class="fas fa-fingerprint text-blueGray-300 mr-2 text-sm"
                ...
                <li class="items-center">
                <a
                  href="http://localhost/aymbol/public/vendedor/listamotos"
                  class="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
                >
                  <i
                    class="fas fa-fingerprint text-blueGray-300 mr-2 text-sm"
                ...
                <li class="items-center">
                <a
                  href="http://localhost/aymbol/public/vendedor/nuevotipoauto"
                  class="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
                >
                  <i
                    class="fas fa-fingerprint text-blueGray-300 mr-2 text-sm"
                  ></i>
                  NUEVO AUTO TIPO DE AUTO
                </a>
              </li>
              <li class="items-center">
                <a
                  href="http://localhost/aymbol/public/vendedor/nuevocombustible"
                  class="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
                >
                  <i
                    class="fas fa-fingerprint text-blueGray-300 mr-2 text-sm"
              ...
              <li class="items-center">
                <a
                  href="http://localhost/aymbol/public/vendedor/nuevatraccion"
                  class="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
                >
                  <i
                    class="fas fa-fingerprint text-blueGray-300 mr-2 text-sm"
                  ></i>
                  NUEVO TIPO DE TRACCIÓN
                </a>
              </li>
              <li class="items-center">
                <a
                  href="http://localhost/aymbol/public/vendedor/nuevotipotrans"
                  class="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
                >
                  <i
                    class="fas fa-fingerprint text-blueGray-300 mr-2 text-sm"
      ...
      <div  style="background-image: url(https://www.wallpaperup.com/uploads/wallpapers/2015/12/08/851726/038fc59c27684eabff2d63ba9351f5af.jpg); background-repeat: no-repeat; background-size: cover"
