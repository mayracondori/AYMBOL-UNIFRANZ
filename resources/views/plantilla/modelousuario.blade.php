...
<html>
  ...
  <body class="text-blueGray-100 antialiased">
    ...
    <div id="root">
        ...
        >
          ...
          >
            ...
            >
              ...
              <li class="items-center">
                <a
                  href="http://localhost/aymbol/public/usuario/miscertificados"
                  class="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
                >
                  <i
                    class="fas fa-user-circle text-blueGray-300 mr-2 text-sm"
                  ></i>
                  LISTA DE MIS CERTIFICADOS
                </a>
              </li>
              <li class="inline-flex">
                ...
                >
                  ...
                  ></i>
                 LISTA DE CONTACTOS CON AUTOESCUELAS
                </a>
              </li>
      ...
      <div  style="background-image: url('https://cdn.pixabay.com/photo/2019/12/17/14/08/landscape-4701725_960_720.jpg'); "
