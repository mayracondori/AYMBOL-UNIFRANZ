            ...
            <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
              <div class="pr-12">
                ...
                <p class="mt-4 text-lg text-blueGray-200">
                  Creando conexiones, rompiendo barreras
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-xl font-semibold">MODULO INFORMATIVO</h6>
                  <p class="mt-2 mb-4 text-blueGray-500">
                   
                   Podras encontrar mucha informacion sobre los documentos legales
                  </p>
                </div>
              </div>
            </div>
            <div class="w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-xl font-semibold">MODULO DE VENTAS</h6>
                  <p class="mt-2 mb-4 text-blueGray-500">
                    Compra  autos y motos de las mejores consesionarias
                  </p>
                </div>
              </div>
            </div>
            <div class="pt-6 w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-xl font-semibold">MODULO CURSOS</h6>
                  <p class="mt-2 mb-4 text-blueGray-500">
                    Podras pasar cursos sobre mecanica basica y otros
                  </p>
                </div>
              </div>
            </div>
