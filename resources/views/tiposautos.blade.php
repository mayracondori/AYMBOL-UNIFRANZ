...
<div class="relative flex flex-col  break-words w-full justify-center " >
                                      ...
                                      <strong> <h1 style="color:white">TIPOS DE AUTOS</h1> 
                                      <br>
                                       ...
                                       <a
                  href="http://localhost/aymbol/public/listainfoautos"
...
<BR></BR>
                                      <div class="row">
                                          <?php
                            $codigo = "SELECT Id_info, Titulo_info FROM informacion where Id_tipoinfo=3";
                    ...
                    <button class="bg-blue-500 text-white active:bg-blue-600 font-bold uppercase text-sm px-6 py-3 rounded  outline-none focus:outline-none  mr-1 mb-1  transition-all " type="button" onclick="toggleModal('<?php echo $titulo1?>')">
                      ...
                      <?php 
                            ...
                            $id=$rest ['Id_info'];
                            $codigo2 = "SELECT Titulo_info,Descripcion_info,Fuente_info,SUBSTRING(Imagen_info, 8)AS Imagen_info FROM informacion where Id_tipoinfo=3 ";
                            ...
                            <!--content-->
                                ...
                                <div  style="justify-content:center" class=" bg-blueGray-200 border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                 <!--header-->
                                        ...
                                        <div  style=" width:750px; height:230px; text-white; overflow: scroll ;background-color:white; " class="relative p-6 flex-auto">
