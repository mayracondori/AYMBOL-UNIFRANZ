...
<div  class="container mx-auto px-4 h-full">
    ...
    <table id="example" class=" text-center stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                    ...
                    <th class="p-3 text-center">Tipo de informacion</th>
  ...
  $codigo = "SELECT * FROM informacion where id_tipoinfo=1 order by Updated_at desc";
