...
<div  class="container mx-auto px-4 h-full">
  ...
  $codigo = "SELECT c.Id_curso, c.Nom_curso,c.Duracion_curso,c.Contenido_curso,i.Nom_inst,c.moa_curso,SUBSTRING(c.Imagen_curso, 8) as Imagen_curso FROM cursos as c, institucion as i WHERE c.moa_curso='AUTO' AND c.Id_inst=$milogueoid and c.Id_inst=i.Id_inst";
...
?>
						<tr>
						<form method="POST" action="{{'detallecurso'}}">
@csrf
