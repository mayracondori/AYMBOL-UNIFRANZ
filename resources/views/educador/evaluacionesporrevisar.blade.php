...
<div  class="container mx-auto px-4 h-full">
  ...
  $codigo = "SELECT con.Id_con,c.Id_curso,con.Id_con,c.Nom_curso, u.Nom_usu,u.App_usu,u.Apm_usu,r.Created_at, SUM(r.Calificacion_res) as cali, r.Updated_at 
  FROM conncursos as con,cursos as c, usuario as u , respuestasevaluacion as r, preguntasevaluacion as p
  WHERE con.Id_curso=c.Id_curso and con.Id_usu=u.Id_usu and c.Id_curso=p.Id_curso and p.Id_pre=r.Id_pre  and con.Certificado_con is null GROUP BY c.Nom_curso";
...
?>
						<tr>
						<form method="POST" action="{{'verevaluacionpararevisar'}}">
@csrf
